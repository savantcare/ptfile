        ...
        if (searchText === addText) {
          await page.waitForSelector(
            '.el-table__row:nth-child(' +
              foundExitTr +
              ') > .el-table_2_column_6 > .cell > .el-button-group > .el-button--primary > span'
          )
          await page.click(
            '.el-table__row:nth-child(' +
              foundExitTr +
          ...
          await page.click('.el-form > .el-form-item > .el-form-item__content > .el-button > span') // Click for submit the change

          await page.waitFor(500)
          await page.waitForSelector(
            '.el-timeline > .el-timeline-item:nth-child(1) > .el-timeline-item__wrapper > .el-timeline-item__content > .api-response-message'
          )
          element = await page.waitForSelector(
            '.el-timeline > .el-timeline-item:nth-child(1) > .el-timeline-item__wrapper > .el-timeline-item__content > .api-response-message'
          )
