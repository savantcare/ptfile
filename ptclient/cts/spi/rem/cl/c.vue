          ...
          /*
            ...
            A): 
                ...
                In real time 3 cases may happen. 
                  1. User changes an existing record
                  2. User already changed a record and then again changes that record
                  3. User adds a record and then changes that newly added record again
