...
export default {
  ...
  computed: {
    ...
    cfArOfRemForDisplayInTable() {
      console.log(
        'cfArOfRemForDisplayInTable called. Whenever ormDx will change this will get called. Even when there are 100 rows in the table when orm dx changes this gets called once'
      )
