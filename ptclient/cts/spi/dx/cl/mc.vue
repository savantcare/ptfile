...
Performance:
Inside dx/cl/c.vue:getRemDescUsingCache enable the console.log 
console.log(
    ...
    <el-carousel arrow="always" trigger="click" :autoplay="false" @change="slideChanged">
      ...
      <el-carousel-item v-for="slide in getNumOfCarouselSlides" :key="slide">
        ...
        <el-row type="flex" :gutter="20">
          <el-col v-for="dxID in getArrayOfRemIDsToShowInThisCard" :key="dxID">
            <el-card>
              <changeRem :first-param="dxID"></changeRem>
            </el-card>
          </el-col>
        </el-row>
      </el-carousel-item>
...
import changeRem from '@/cts/spi/dx/cl/c.vue'
export default {
