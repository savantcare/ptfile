...
describe('Test header and title of the page', () => {
    ...
    test('Change Data Using Mouse click', async () => {
        ...
        for(i=1 ; i <= foundExitTr; i++)
        {
            ...
            if(searchText == addText)
            {
				...
				await page.waitForSelector('#recommendation-CurrentStateDisplayArea .el-table__body > tbody > tr:nth-child(2) > td:nth-child(4) > .cell > .el-button:nth-child(1) > span');
                await page.click('#recommendation-CurrentStateDisplayArea .el-table__body > tbody > tr:nth-child(2) > td:nth-child(4) > .cell > .el-button:nth-child(1) > span');
            }
        }
