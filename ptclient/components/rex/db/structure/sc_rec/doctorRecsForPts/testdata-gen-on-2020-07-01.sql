...
INSERT INTO `doctorRecsForPts` (`uuid`, `uuidOfRecMadeFor`, `recDescription`, `notes`, `priority`, `isAutoRec`, `autoRecsOrderId`, `recordChangedByUUID`, `recordChangedFromIPAddress`) VALUES
