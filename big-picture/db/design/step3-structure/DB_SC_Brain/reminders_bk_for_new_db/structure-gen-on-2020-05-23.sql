...
--
-- Table structure for table `reminders_bk_for_new_db`
--

DROP TABLE IF EXISTS `reminders_bk_for_new_db`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reminders_bk_for_new_db` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8452 DEFAULT CHARSET=latin1;
