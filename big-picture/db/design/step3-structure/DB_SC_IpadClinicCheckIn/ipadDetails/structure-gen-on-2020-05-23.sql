...
CREATE TABLE `ipadDetails` (
  ...
  `deviceIdentifierName` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 COMMENT='all iPad details which have check-in ios app installed';
