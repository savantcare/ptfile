...
--
-- Temporary table structure for view `cronCreatedForCacheUsedByPaymentsReport2`
--

DROP TABLE IF EXISTS `cronCreatedForCacheUsedByPaymentsReport2`;
/*!50001 DROP VIEW IF EXISTS `cronCreatedForCacheUsedByPaymentsReport2`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `cronCreatedForCacheUsedByPaymentsReport2` AS SELECT 
 1 AS `paymentTableId`,
...
--
-- Final view structure for view `cronCreatedForCacheUsedByPaymentsReport2`
--
