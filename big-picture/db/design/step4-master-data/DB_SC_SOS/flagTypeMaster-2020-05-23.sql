...
--
-- Dumping data for table `flagTypeMaster`
--

LOCK TABLES `flagTypeMaster` WRITE;
/*!40000 ALTER TABLE `flagTypeMaster` DISABLE KEYS */;
/*!40000 ALTER TABLE `flagTypeMaster` ENABLE KEYS */;
UNLOCK TABLES;
