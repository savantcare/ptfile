...
--
-- Dumping data for table `screenTechTestForDAMasterGroups`
--

LOCK TABLES `screenTechTestForDAMasterGroups` WRITE;
/*!40000 ALTER TABLE `screenTechTestForDAMasterGroups` DISABLE KEYS */;
/*!40000 ALTER TABLE `screenTechTestForDAMasterGroups` ENABLE KEYS */;
UNLOCK TABLES;
