...
--
-- Dumping data for table `screenTechTestForDAMasterQuestions`
--

LOCK TABLES `screenTechTestForDAMasterQuestions` WRITE;
/*!40000 ALTER TABLE `screenTechTestForDAMasterQuestions` DISABLE KEYS */;
INSERT INTO `screenTechTestForDAMasterQuestions` VALUES (1,NULL,'No','Your data is not showing correctly in the report, what should you do first?',NULL,NULL,'No','Select box','Cry and ask for Robert','Create a million Github issues on the same bug','Ckear your Browser or report Cache','Do nothing.','',0,0,0,0,0);
/*!40000 ALTER TABLE `screenTechTestForDAMasterQuestions` ENABLE KEYS */;
UNLOCK TABLES;
