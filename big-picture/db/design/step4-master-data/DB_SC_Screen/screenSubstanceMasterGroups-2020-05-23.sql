...
--
-- Dumping data for table `screenSubstanceMasterGroups`
--

LOCK TABLES `screenSubstanceMasterGroups` WRITE;
/*!40000 ALTER TABLE `screenSubstanceMasterGroups` DISABLE KEYS */;
/*!40000 ALTER TABLE `screenSubstanceMasterGroups` ENABLE KEYS */;
UNLOCK TABLES;
