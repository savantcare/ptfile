...
--
-- Dumping data for table `screenRKscreenMasterQuestions`
--

LOCK TABLES `screenRKscreenMasterQuestions` WRITE;
/*!40000 ALTER TABLE `screenRKscreenMasterQuestions` DISABLE KEYS */;
/*!40000 ALTER TABLE `screenRKscreenMasterQuestions` ENABLE KEYS */;
UNLOCK TABLES;
