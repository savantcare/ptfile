...
--
-- Dumping data for table `screenBeckDepressionInventoryMasterGroups`
--

LOCK TABLES `screenBeckDepressionInventoryMasterGroups` WRITE;
/*!40000 ALTER TABLE `screenBeckDepressionInventoryMasterGroups` DISABLE KEYS */;
/*!40000 ALTER TABLE `screenBeckDepressionInventoryMasterGroups` ENABLE KEYS */;
UNLOCK TABLES;
