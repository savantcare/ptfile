...
--
-- Dumping data for table `screenSchizophreniaMasterGroups`
--

LOCK TABLES `screenSchizophreniaMasterGroups` WRITE;
/*!40000 ALTER TABLE `screenSchizophreniaMasterGroups` DISABLE KEYS */;
/*!40000 ALTER TABLE `screenSchizophreniaMasterGroups` ENABLE KEYS */;
UNLOCK TABLES;
