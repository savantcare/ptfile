...
--
-- Dumping data for table `screenTestMasterQuestions`
--

LOCK TABLES `screenTestMasterQuestions` WRITE;
/*!40000 ALTER TABLE `screenTestMasterQuestions` DISABLE KEYS */;
/*!40000 ALTER TABLE `screenTestMasterQuestions` ENABLE KEYS */;
UNLOCK TABLES;
