...
--
-- Dumping data for table `screenDrugMasterGroups`
--

LOCK TABLES `screenDrugMasterGroups` WRITE;
/*!40000 ALTER TABLE `screenDrugMasterGroups` DISABLE KEYS */;
/*!40000 ALTER TABLE `screenDrugMasterGroups` ENABLE KEYS */;
UNLOCK TABLES;
