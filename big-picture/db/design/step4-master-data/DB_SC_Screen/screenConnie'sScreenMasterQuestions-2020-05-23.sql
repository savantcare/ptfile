...
--
-- Dumping data for table `screenConnie'sScreenMasterQuestions`
--

LOCK TABLES `screenConnie'sScreenMasterQuestions` WRITE;
/*!40000 ALTER TABLE `screenConnie'sScreenMasterQuestions` DISABLE KEYS */;
/*!40000 ALTER TABLE `screenConnie'sScreenMasterQuestions` ENABLE KEYS */;
UNLOCK TABLES;
