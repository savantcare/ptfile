...
--
-- Dumping data for table `processingFeesDetailsMaster`
--

LOCK TABLES `processingFeesDetailsMaster` WRITE;
/*!40000 ALTER TABLE `processingFeesDetailsMaster` DISABLE KEYS */;
INSERT INTO `processingFeesDetailsMaster` VALUES (1,'Merchant One','Credit card',3.00,0.00,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `processingFeesDetailsMaster` ENABLE KEYS */;
UNLOCK TABLES;
