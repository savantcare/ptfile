...
--
-- Dumping data for table `timeInPsytxMaster`
--

LOCK TABLES `timeInPsytxMaster` WRITE;
/*!40000 ALTER TABLE `timeInPsytxMaster` DISABLE KEYS */;
INSERT INTO `timeInPsytxMaster` VALUES (1,'>= 16',549,'2016-07-26 14:30:31','IST'),(2,'>= 38',549,'2016-07-26 14:30:31','IST'),(3,'>= 53',549,'2016-07-26 14:30:31','IST');
/*!40000 ALTER TABLE `timeInPsytxMaster` ENABLE KEYS */;
UNLOCK TABLES;
