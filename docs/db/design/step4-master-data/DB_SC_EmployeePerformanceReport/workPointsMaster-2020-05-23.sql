...
--
-- Dumping data for table `workPointsMaster`
--

LOCK TABLES `workPointsMaster` WRITE;
/*!40000 ALTER TABLE `workPointsMaster` DISABLE KEYS */;
INSERT INTO `workPointsMaster` VALUES (1,10.00,10.00,5.00,10.00,0.00,7.50,-20.00,-1.00,-5.00,-10.00,-5.00,-2.00,-5.00,-5.00,-5.00);
/*!40000 ALTER TABLE `workPointsMaster` ENABLE KEYS */;
UNLOCK TABLES;
