...
--
-- Dumping data for table `notifierMasterTemplatePlaceholdersForEmailSubject`
--

LOCK TABLES `notifierMasterTemplatePlaceholdersForEmailSubject` WRITE;
/*!40000 ALTER TABLE `notifierMasterTemplatePlaceholdersForEmailSubject` DISABLE KEYS */;
/*!40000 ALTER TABLE `notifierMasterTemplatePlaceholdersForEmailSubject` ENABLE KEYS */;
UNLOCK TABLES;
