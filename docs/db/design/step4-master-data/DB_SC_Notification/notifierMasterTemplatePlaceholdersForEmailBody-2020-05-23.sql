...
--
-- Dumping data for table `notifierMasterTemplatePlaceholdersForEmailBody`
--

LOCK TABLES `notifierMasterTemplatePlaceholdersForEmailBody` WRITE;
/*!40000 ALTER TABLE `notifierMasterTemplatePlaceholdersForEmailBody` DISABLE KEYS */;
/*!40000 ALTER TABLE `notifierMasterTemplatePlaceholdersForEmailBody` ENABLE KEYS */;
UNLOCK TABLES;
