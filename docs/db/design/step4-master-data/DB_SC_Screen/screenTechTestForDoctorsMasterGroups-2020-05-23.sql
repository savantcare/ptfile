...
--
-- Dumping data for table `screenTechTestForDoctorsMasterGroups`
--

LOCK TABLES `screenTechTestForDoctorsMasterGroups` WRITE;
/*!40000 ALTER TABLE `screenTechTestForDoctorsMasterGroups` DISABLE KEYS */;
/*!40000 ALTER TABLE `screenTechTestForDoctorsMasterGroups` ENABLE KEYS */;
UNLOCK TABLES;
