...
--
-- Dumping data for table `screenAlcoholismscreeningMasterQuestions`
--

LOCK TABLES `screenAlcoholismscreeningMasterQuestions` WRITE;
/*!40000 ALTER TABLE `screenAlcoholismscreeningMasterQuestions` DISABLE KEYS */;
INSERT INTO `screenAlcoholismscreeningMasterQuestions` VALUES (1,NULL,'No','Do you enjoy drinking now and then?',NULL,NULL,'Yes','Select Box','Yes','No',NULL,NULL,NULL,1,NULL,NULL,NULL,NULL),(2,NULL,'No','Do you feel you are a normal drinker? ( \"normal\" -- drink as much or less than most other people)',NULL,NULL,'Yes','Select Box','Yes','No',NULL,NULL,NULL,2,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `screenAlcoholismscreeningMasterQuestions` ENABLE KEYS */;
UNLOCK TABLES;
