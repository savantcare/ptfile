...
--
-- Dumping data for table `screenYBOCSMasterQuestions`
--

LOCK TABLES `screenYBOCSMasterQuestions` WRITE;
/*!40000 ALTER TABLE `screenYBOCSMasterQuestions` DISABLE KEYS */;
/*!40000 ALTER TABLE `screenYBOCSMasterQuestions` ENABLE KEYS */;
UNLOCK TABLES;
