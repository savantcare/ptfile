...
--
-- Dumping data for table `historyMaster`
--

LOCK TABLES `historyMaster` WRITE;
/*!40000 ALTER TABLE `historyMaster` DISABLE KEYS */;
INSERT INTO `historyMaster` VALUES (1,'Problem focussed',11,'2016-05-16 00:00:00','PST'),(2,'Expanded problem focused\r\n',0,'0000-00-00 00:00:00',''),(3,'Detailed',0,'0000-00-00 00:00:00',''),(4,'Comprehensive',0,'0000-00-00 00:00:00','');
/*!40000 ALTER TABLE `historyMaster` ENABLE KEYS */;
UNLOCK TABLES;
