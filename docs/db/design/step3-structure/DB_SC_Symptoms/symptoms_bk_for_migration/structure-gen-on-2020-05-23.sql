...
--
-- Table structure for table `symptoms_bk_for_migration`
--

DROP TABLE IF EXISTS `symptoms_bk_for_migration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `symptoms_bk_for_migration` (
  ...
  `severity` enum('None(0)','Mild(1)','Moderate(2)','Severe(3)') COLLATE utf8_unicode_ci NOT NULL,
