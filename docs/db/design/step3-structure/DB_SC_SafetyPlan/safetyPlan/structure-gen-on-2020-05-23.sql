use DB_SC_SafetyPlan;
-- MySQL dump 10.13  Distrib 5.7.26, for Linux (x86_64)
--
-- Host: localhost    Database: DB_SC_SafetyPlan
-- ------------------------------------------------------
...
--
-- Table structure for table `safetyPlan`
--
...
CREATE TABLE `safetyPlan` (
  ...
  `beingEditedByUID` int(11) DEFAULT NULL,
  `signedByUID` int(11) DEFAULT NULL,
  `signedAt` datetime DEFAULT NULL,
  `signatureImage` longblob NOT NULL,
  PRIMARY KEY (`id`)
